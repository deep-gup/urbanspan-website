...
async function runBrowserFormSecurityHarness() {
  ...
  try {
    ...
    for (let r = 0; r < 3; r++) {
      try {
        await page.goto('https://urbanspaninfra.co.in/product/US-TMT-550D', { waitUntil: 'domcontentloaded', timeout: 30000 });
        prodNavOk = true;
        break;
      } catch (e) {
        await page.waitForTimeout(2000);
    ...
    if (prodNavOk) {
      ...
      failures.push('Could not navigate to /product/US-TMT-550D after retries');
    }
